...
def main():
    init()
    digits=read_process_template(template_path)
    read_process_image(image_path,digits)

if __name__=='__main__':
    image_path = r'./images/credit_card_01.png'
    template_path = r'./ocr_a_reference.png'
    template_high,template_wigth=57,88
    # 指定信用卡类型
    FIRST_NUMBER = {
        "3": "American Express",
        "4": "Visa",
